...
function CourseStatus({courseDetail}:Props) {
    ...
    const GetCounts = () => {
        ...
        courseDetail?.chapters?.forEach((chapter)=>{
            ...
            chapter?.exercises?.forEach(exc => {totalXp = totalXp+exc?.xp})
        })
        setCounts({
    ...
    <div className='font-game p-4 border-4 rounded-2xl w-full'>
        ...
        <div className='flex items-center gap-5 mt-4'>
            ...
            <div className='w-full'>
                <h2 className='flex justify-between text-2xl '>Exercises <span className='text-gray-400'>1/{counts?.totalExce}</span></h2>
